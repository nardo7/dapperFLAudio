...
class FederatedDataset:
    ...
    def __init__(self, args: Namespace) -> None:
        self.train_loaders: list[torch.utils.data.DataLoader] = []
        self.test_loader: list[torch.utils.data.DataLoader] = []
        self.args = args
...
def partition_label_skew_loaders(
    train_dataset: datasets, test_dataset: datasets, setting: FederatedDataset
) -> Tuple[list, DataLoader, dict]:
...
def partition_office_domain_skew_loaders_new(
